...
```{r}
siglas_aut_y_nac <- function(data,var){
  data <- data |> mutate(siglas2 = if_else(var %in% c("PSOE","PP","VOX","CS","MP","UP"),
...
::: callout-warning
Comentar del segundo chunk (chunk_comentar) el cambio de votos en cada provincia hacia los partidos a medida que aumenta el censo. Valorar si se hace por siglas o por siglas2.
:::
