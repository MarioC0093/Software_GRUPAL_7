...
pr1 |> 
  ...
  geom_text(aes(label = percent(prop)), format = "%.0f%%", position = position_fill(0.5)) +
  tema_7 + 
  theme(legend.position = "bottom") +
  labs(
    title = "Porcentaje de votos nacionales autonómicos por elección ",
    x = "Fecha elección",
...
## Diferencias a nivel provincial A nivel provincial, se buscaron aquellas provincias con una diferencia mayor al 25%.
...
pr6 |> 
  ...
  #geom_text(aes(label = (prop*100)), position = position_fill(0.5)) +
  tema_7 + 
  scale_fill_manual(values = pr6$color_politico) +
  theme(legend.position = "bottom") +
  labs(
    title = "Proporción de votos en cada elección por partido",
    caption = "Solo considerando municipios con más de 100.000 habitantes.",
...
pr6.2 |> 
  ...
  #geom_text(aes(label = (prop*100)), position = position_fill(0.5)) +
  tema_7 + 
  scale_fill_manual(values = pr6.2$color_politico) +
  theme(legend.position = "bottom") +
  labs(
    title = "Proporción de votos en cada elección por partido",
    caption = "Solo considerando municipios con más de 100.000 habitantes.",
...
# Encuestas 
## MARIO CHEQUEA PORFA QUE PASA CON LAS SIGLAS DE LAS ENCUESTAS ¿PARECE QUE IU DEBERÍA UNIRSE A UP? ##Una vez tengamos eso hay que hacer el factor de las siglas de nuevo, porque otros queda raro
