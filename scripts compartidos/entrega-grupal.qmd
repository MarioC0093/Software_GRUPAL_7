...
```{r}
#Borrar variables del environment
rm(list = ls())
#Cargar librerias 
library(tidyverse)
library(stringi)
...
La base de datos "datos_elecciones" original es un tible de 48737x471 lo que impide su comprensión para un correcto análisis de datos.
